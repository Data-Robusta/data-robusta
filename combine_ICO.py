...
#Total Production--------------------------------
total_p = pd.read_excel("ico_data/total_prod.xlsx")
...
total_p.to_csv("total_production.csv")
#-------------------------------------
#Domestic Consumption----------------------------
dom_con = pd.read_excel("ico_data/dom_cons.xlsx")
...
dom_con.to_csv("domestic_consumption.csv")
#-------------------------------------
#Exportable Production--------------------------
export_p = pd.read_excel("ico_data/exp_prod.xlsx")
...
export_p.to_csv("exportable_production.csv")
#-------------------------------------
#Gross opening stockpiles in all exporting countries
stock_pile = pd.read_excel("ico_data/gross_open.xlsx")
...
stock_pile.to_csv("beginning_stockpile.csv")
#-------------------------------------
#Total Exports-----------------------------------
exports = pd.read_excel("ico_data/exports.xlsx")
...
exports.to_csv("total_exports.csv")
#-------------------------------------
#Imports--------------------------------------
imports = pd.read_excel("ico_data/imports.xlsx")
...
imports.to_csv("total_imports.csv")
#-------------------------------------
#Re-Exports-----------------------------------
re_exports = pd.read_excel("ico_data/re_exports.xlsx")
...
re_exports.to_csv("total_re_exports.csv")
#-------------------------------------
#Amount paid to Growers in USDCent per Pound--
prices = pd.read_excel("ico_data/prices_paid_to_growers.xlsx")
...
prices.to_csv("paid_to_growers.csv")
#-------------------------------------
#Retail Price of Coffee in USD per Pound-----
retail_prices = pd.read_excel("ico_data/retail_price.xlsx")
